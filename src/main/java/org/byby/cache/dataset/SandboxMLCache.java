...
public class SandboxMLCache {
     ...
     */
    public IgniteCache<Integer, Vector> fillCacheWith(MLDatasets dataset) throws FileNotFoundException {
        IgniteCache<Integer, Vector> cache = getCache(dataset.name());
    ...
    private IgniteCache<Integer, Vector> getCache(String name) {
